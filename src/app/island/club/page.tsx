...
import { ArrowLeft, Heart, Music, Sparkles, Users, User, Send, Crown, Star, Flame } from "lucide-react";
...
const ISLANDER_PROFILES: IslanderProfile[] = [
  {
    ...
    age: 24,
    gender: "female",
    image: "https://replicate.delivery/xezq/j1eVwcF0dTTjc6fN8SVwSbLuCn3StTR6vERi5SuvHKXw09UUA/tmpba2mafkc.jpg",
    status: "single",
    score: 850,
  ...
  },
  {
    ...
    age: 26,
    gender: "male",
    image: "https://replicate.delivery/xezq/hDbljQXQNUKMN1fJvoC7506sPKZDLQilVaqQKpVaSjes49UUA/tmpje0oe2wd.jpg",
    status: "coupled",
    partner: "Emma",
    score: 920,
...

  {
    ...
    age: 27,
    gender: "male",
    image: "https://replicate.delivery/xezq/P60YpYeXsUSwMC8ll1q4m6o0223OuxFEVhu9IQgFLkoIhkKKA/tmpbjf686ug.jpg",
    status: "single",
    score: 780,
  ...
  },
  {
    ...
    age: 25,
    gender: "female",
    image: "https://replicate.delivery/xezq/jwUzI6BvuuZDE9LGDMoQcnNjOfgvUYjf493fcnUyLeGsZkURB/tmpsw4qo2t9.jpg",
    status: "single",
    score: 830,
  ...
  },
  {
    ...
    age: 28,
    gender: "male",
    image: "https://replicate.delivery/xezq/uyI5DPNveVTWA6vbpEbvZmoETHVmpuJ4CO53le9fNMJvQSqoA/tmpgl2s7xki.jpg",
    status: "single",
    score: 910,
  ...
  },
  {
    ...
    age: 23,
    gender: "female",
    image: "https://replicate.delivery/xezq/aN6e6EGo3XVsSSwyjbD1Iy7OcntgHTPHYPDQi83Jwa4IikKKA/tmpekmp70_f.jpg",
    status: "coupled",
    partner: "Mike",
    score: 890,
...
export default function SunsetClubPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {!imageLoaded && <div className="fixed inset-0 bg-gradient-to-b from-purple-500 to-pink-600 z-0" />}
        ...
        <div className="w-full max-w-2xl">
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-purple-500/80 to-pink-500/80 p-4 text-center border-b border-white/20">
              ...
              <p className="font-handwritten text-lg text-white/90 mt-1">discover your perfect match</p>
            </div>
            ...
            <div className="p-4 border-b border-white/10">
              <div className="flex flex-wrap gap-3">
                {/* Gender Filter */}
                <Select value={genderFilter} onValueChange={(value: GenderFilter) => setGenderFilter(value)}>
                  <SelectTrigger
                  ...
                  <SelectContent className="bg-black/90 border-white/20">
                    ...
                    <SelectItem value="male" className="text-white hover:bg-white/20">
                      Male
                    </SelectItem>
                    <SelectItem value="female" className="text-white hover:bg-white/20">
                      Female
                    </SelectItem>
                  </SelectContent>
                </Select>
                ...
                <Select value={statusFilter} onValueChange={(value: StatusFilter) => setStatusFilter(value)}>
                  <SelectTrigger
                    className="w-[140px] bg-gradient-to-r from-pink-500/10 to-rose-500/10 
                             ...
                             transition-all duration-200"
                  >
                    {statusFilter === "single" ? <User className="w-4 h-4 mr-2" /> : <Users className="w-4 h-4 mr-2" />}
                  ...
                  <SelectContent className="bg-black/90 border-white/20">
                    ...
                    <SelectItem value="single" className="text-white hover:bg-white/20">
                      Single
                    </SelectItem>
                    <SelectItem value="coupled" className="text-white hover:bg-white/20">
                      Coupled
                    </SelectItem>
                  </SelectContent>
                </Select>
                ...
                <Select value={typeFilter} onValueChange={(value: TypeFilter) => setTypeFilter(value)}>
                  ...
                  <SelectContent className="bg-black/90 border-white/20">
                    ...
                    {Object.entries(TYPE_STYLES).map(([type, style]) => (
                      <SelectItem key={type} value={type} className="text-white hover:bg-white/20">
                        {style.label}
                      </SelectItem>
                    ))}
                  </SelectContent>
                          ...
                          <div className="absolute top-2 right-2">
                            ...
                            >
                              {profile.status === "single" ? (
                                <User className={cn("w-3 h-3", STATUS_STYLES[profile.status].iconColor)} />
                              ) : (
                                <Users className={cn("w-3 h-3", STATUS_STYLES[profile.status].iconColor)} />
                              )}
                          ...
                          <div className="absolute top-2 left-2">
                            ...
                            >
                              {(() => {
                                ...
                                return <Icon className={cn("w-3 h-3", TYPE_STYLES[profile.type].iconColor)} />;
                              })()}
                              <span className="text-white text-[10px] font-display">
                        ...
                        <div className="p-3">
                          <div className="flex items-start justify-between mb-1">
                            <div>
                              ...
                              {profile.partner && <p className="text-white/70 text-xs">with {profile.partner}</p>}
                            </div>
                            <div
                            ...
                            >
                              ...
                              <span className="font-display text-sm text-white">{profile.score}</span>
                            </div>
                          </div>

                          <p className="text-white/70 text-xs mb-3 line-clamp-2">{profile.bio}</p>

                          <div className="flex items-center justify-between">
                            <div className="text-white/50 text-xs font-display">{profile.lastActive}</div>
                            <Button
